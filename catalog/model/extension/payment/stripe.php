<?php
//==============================================================================
// Stripe Payment Gateway v2022-2-22 (also set below)
// 
...
class ModelExtensionPaymentStripe extends Model {		
	...
	private $name = 'stripe';
	private $extension_version = 'v2022-2-22';
	...
	public function createOrder($order_data) {
		...
		$default_order_data = array(
			...
			'payment_method'			=> html_entity_decode($settings['title_' . $language], ENT_QUOTES, 'UTF-8'),
