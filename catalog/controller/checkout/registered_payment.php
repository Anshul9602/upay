<?php
class ControllerCheckoutRegisteredPayment extends Controller
{
	public function index()
	{
		$this->load->language('checkout/checkout');
		$this->document->setTitle("Billing Address");
		...
		$this->response->setOutput($this->load->view('checkout/payment_address_new', $data));
	}
