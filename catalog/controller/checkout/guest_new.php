<?php
class ControllerCheckoutGuestNew extends Controller {
	public function index() {
		$this->load->language('checkout/checkout');

		$data['customer_groups'] = array();
		$this->document->setTitle('Billing Information');
		...
		$this->response->setOutput($this->load->view('checkout/guest_new', $data));
	}
