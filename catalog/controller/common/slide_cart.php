<?php
class ControllerCommonSlideCart extends Controller {
	public function index() {
		...
		foreach ($totals as $total) {
			...
			if($total['title']==="Total"){
				$data['final_total'] = $this->currency->format($total['value'], $this->session->data['currency']);
			}
		...
		return $this->load->view('common/slide_cart', $data);
	}
