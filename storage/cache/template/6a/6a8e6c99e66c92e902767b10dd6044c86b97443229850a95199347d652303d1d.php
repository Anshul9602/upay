...
class __TwigTemplate_63686b3151531cf2a606b742f8d849c9663cf63128cd90986bcc7817b412a5ab extends \Twig\Template
{
    private $source;
    private $macros = [];
   ...
   <div class=\"row\">
      ...
      <div class=\"slider_banner col-12 mobile-banner\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["banner"]) {
            // line 214
            echo "            <a href=\"";
            echo twig_get_attribute($this->env, $this->source, $context["banner"], "link", [], "any", false, false, false, 214);
            echo "\">
               <img src=\"";
            // line 215
            echo twig_get_attribute($this->env, $this->source, $context["banner"], "image", [], "any", false, false, false, 215);
            echo "\" alt
                  class=\"img-response slider-img\">
            </a>
            ";
...
";
    ...
    {
        return array (  477 => 408,  286 => 219,  276 => 215,  271 => 214,  267 => 213,  260 => 208,  250 => 204,  245 => 203,  241 => 202,  37 => 1,);
    }
