...
class __TwigTemplate_2673c83d1b799090cb0280de185abe3d30b73a78234ad6c7dcc24f3163a5842f extends \Twig\Template
{
    private $source;
    private $macros = [];
   ...
   <div class=\"row\">
      ...
      <div class=\"slider_banner col-12 mobile-banner\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["banner"]) {
            // line 231
            echo "            <a href=\"";
            echo twig_get_attribute($this->env, $this->source, $context["banner"], "link", [], "any", false, false, false, 231);
            echo "\">
               <img src=\"";
            // line 232
            echo twig_get_attribute($this->env, $this->source, $context["banner"], "image", [], "any", false, false, false, 232);
            echo "\" alt class=\"img-response slider-img\">
            </a>
            ";
        }
                  ...
                  <div class=\"row\">
                     ...
                     <div class=\"col-md-7 row align-content-center\">
                        <div class=\"tt col-12\" style=\"background-color: #F2F1F0;padding:3%;\">
                           <h2 style=\"font-size: 56px;color:#313131;font-weight:600;\"> Expert Consulting <span
...
";
    ...
    {
        return array (  556 => 487,  302 => 235,  293 => 232,  288 => 231,  284 => 230,  277 => 225,  258 => 212,  253 => 211,  249 => 210,  37 => 1,);
    }
