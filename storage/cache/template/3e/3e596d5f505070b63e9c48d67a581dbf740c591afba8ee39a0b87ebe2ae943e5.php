...
class __TwigTemplate_9cba580eea7a092f711e2abd598cf3bc9bc8927e07a5f88ee436a99a34e9e5ea extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        if (($context["price"] ?? null)) {
            ...
            if ( !($context["special"] ?? null)) {
                ...
                echo "</h3>
                        ...
                        <li><h4>";
                // line 288
                echo (twig_replace_filter(($context["special"] ?? null), ["US\$ " => ""]) - twig_replace_filter(($context["price"] ?? null), ["US\$ " => ""]));
                echo "</h4></li>
            ...
            if (($context["discounts"] ?? null)) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["discount"]) {
                    // line 306
                    echo "                        <li>";
                    echo twig_get_attribute($this->env, $this->source, $context["discount"], "quantity", [], "any", false, false, false, 306);
                    echo ($context["text_discount"] ?? null);
                    echo twig_get_attribute($this->env, $this->source, $context["discount"], "price", [], "any", false, false, false, 306);
                    echo "</li>
                        ";
                }
                $_parent = $context['_parent'];
      ...
      <div class=\"col-sm-10 offset-sm-1\">
        ...
        if (($context["attribute_groups"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["attribute_group"]) {
                ...
                echo "                  <thead>
                     <tr>
                        <td colspan=\"2\">
                           <strong>";
                // line 354
                echo twig_get_attribute($this->env, $this->source, $context["attribute_group"], "name", [], "any", false, false, false, 354);
                echo "</strong>
                        </td>
                     </tr>
                  </thead>
                ...
                // line 359
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, $context["attribute_group"], "attribute", [], "any", false, false, false, 359));
                foreach ($context['_seq'] as $context["_key"] => $context["attribute"]) {
                    ...
                    echo "</td>
                        <td>";
                    // line 362
                    echo twig_get_attribute($this->env, $this->source, $context["attribute"], "text", [], "any", false, false, false, 362);
                    echo "</td>
                     </tr>
                     ";
                }
         ...
         <div class=\"splide__track\">
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
                ...
                echo "</p>
                        ";
                // line 444
                if (twig_get_attribute($this->env, $this->source, $context["product"], "rating", [], "any", false, false, false, 444)) {
                    // line 445
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["j"]) {
                        // line 447
                        echo "                           ";
                        if ((twig_get_attribute($this->env, $this->source, $context["product"], "rating", [], "any", false, false, false, 447) < $context["j"])) {
                            // line 448
                            echo "                           <span class=\"fa fa-stack\">
                           <i class=\"fa fa-star-o fa-stack-1x\"></i>
                           </span>
...
\t\t\t\t\t\t 
                    ...
                    if (twig_get_attribute($this->env, $this->source, $context["product"], "tax", [], "any", false, false, false, 469)) {
                        ...
                        echo "
                           ";
                        // line 471
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "tax", [], "any", false, false, false, 471);
                        echo "</span>
                           ";
                    }
                    // line 473
