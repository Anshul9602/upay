...
class __TwigTemplate_af00059354ee638379de69f18a4b5ba8e1b0e6f4f5170a25dc74e3082a62bd55 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<script type=\"text/javascript\">
   ...
   \$(document).ready(function(){
      if(\$(\"#you_save\").length !=0){
         og = \$(\"#og\").text().match(/\\d+\\.\\d+/)[0];
         sp = \$(\"#sp\").text().match(/\\d+\\.\\d+/)[0];
         alert(og);
         alert(sp);
