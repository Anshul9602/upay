...
class __TwigTemplate_61f5be96627f2ecd22cdfe64c73b9eb21b16fa1503455324d5a1373559eb37d4 extends \Twig\Template
{
    private $source;
    private $macros = [];
   ...
   <div class=\"row\">
      ...
      <div class=\"slider_banner col-12 mobile-banner\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["banner"]) {
            // line 125
            echo "            <a href=\"";
            echo twig_get_attribute($this->env, $this->source, $context["banner"], "link", [], "any", false, false, false, 125);
            echo "\">
               <img src=\"";
            // line 126
            echo twig_get_attribute($this->env, $this->source, $context["banner"], "image", [], "any", false, false, false, 126);
            echo "\" alt class=\"img-response slider-img\">
            </a>
            ";
        }
...
";
    ...
    {
        return array (  611 => 542,  196 => 129,  187 => 126,  182 => 125,  178 => 124,  172 => 120,  163 => 117,  158 => 116,  154 => 115,  37 => 1,);
    }
