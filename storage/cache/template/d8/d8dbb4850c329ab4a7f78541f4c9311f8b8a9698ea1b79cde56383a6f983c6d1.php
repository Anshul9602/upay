...
class __TwigTemplate_1d21d581cc042fe4163989a097abcef1b455c4ac9046fc26c4804c42f5550392 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<script>
    ...
    function updateProgress(splideInstance) {
      ...
      var counter = splideInstance.root.querySelector('.splide__counter');
      bar.style.width = String((100 * (splideInstance.index + 1)) / end) + '%';
      counter.textContent = `Slide \${splideInstance.index + 1} of \${end}`;
    }
...
";
    ...
    {
        return array (  335 => 263,  249 => 179,  239 => 175,  234 => 174,  230 => 173,  223 => 168,  213 => 164,  208 => 163,  204 => 162,  196 => 157,  37 => 1,);
    }
