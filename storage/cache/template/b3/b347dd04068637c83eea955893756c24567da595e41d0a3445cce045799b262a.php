...
class __TwigTemplate_be1f766d83c8605592b3318d33ad5c222571338d7c9d8a6626fcf9de4f3fd2dc extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t<a href=\"index.php?route=information/contact\">
\t\t\t\t\t\t\t<button class=\"btn btn-primary \" style=\"padding: 10px 24px;font-size:12px;\">Book An Appointment</button>
\t\t\t\t\t\t</a>
