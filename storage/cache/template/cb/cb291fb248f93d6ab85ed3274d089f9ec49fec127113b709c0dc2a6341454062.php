...
class __TwigTemplate_4e1da2daee682b4d7dd4841915e89b1adf7a91e2174017f163f20707fdc4c484 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<script type=\"text/javascript\">
   ...
   \$(document).ready(function(){
      if(\$(\"#you_save\").length !=0){
         og = \$(\"#og\").text().replace(/\\D/g,'');
         sp = \$(\"#sp\").text().replace(/\\D/g,'');
         alert(og);
         alert(sp);
