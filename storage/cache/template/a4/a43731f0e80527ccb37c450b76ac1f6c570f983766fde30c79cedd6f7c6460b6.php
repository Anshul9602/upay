...
class __TwigTemplate_c11065f4126edd06aa59e1fd44eb4f10fbcefb07376fb3cac36adf1690989528 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<script type=\"text/javascript\">
   ...
   \$(document).ready(function(){
      if(\$(\"#you_save\").length !=0){
         og = \$(\"#og\").text().match(/[\\d,]+\\.?\\d*/)[0].replace(/,/g, '');
         sp = \$(\"#sp\").text().match(/[\\d,]+\\.?\\d*/)[0].replace(/,/g, '');
         alert(og);
         alert(sp);
         \$(\"#you_save\").text(\"US\$ \"+og-sp);
      }
   })
