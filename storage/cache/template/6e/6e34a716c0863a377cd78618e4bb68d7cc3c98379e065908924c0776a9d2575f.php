...
class __TwigTemplate_221a3b7a87d5271947ad20cd98d1ae5deebf067ac7f6cea297141632bd45cecd extends \Twig\Template
{
    private $source;
    private $macros = [];
   ...
   <div class=\"row\">
      <div class=\"slider_banner col-12 desktop-banner\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["banner"]) {
            // line 217
            echo "            <a href=\"";
            echo twig_get_attribute($this->env, $this->source, $context["banner"], "link", [], "any", false, false, false, 217);
            echo "\"style=\"position: relative;\">
               <img src=\"";
            // line 218
            echo twig_get_attribute($this->env, $this->source, $context["banner"], "image", [], "any", false, false, false, 218);
            echo "\" alt class=\"img-response slider-img\">
               <div class=\"uuu\" style=\"position: absolute;bottom:0;left:30%\">
                  <div class=\"card text-center\" style=\"background-color: #F6F6F6;width:700px;    border-radius: 90px;    margin: auto;    border: none;\">
                    
                     <div class=\"card-body\">
                        <h4 class=\"card-title\" style=\"color: #906CD4;font-size:26px;    margin: 0;\"><span style=\"font-weight: 700;color:#692BD8;\">I Need</span> Corporate Finance Solutions.</h4>
      ...
      <div class=\"slider_banner col-12 mobile-banner\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["banner"]) {
            // line 237
            echo "            <a href=\"";
            echo twig_get_attribute($this->env, $this->source, $context["banner"], "link", [], "any", false, false, false, 237);
            echo "\">
               <img src=\"";
            // line 238
            echo twig_get_attribute($this->env, $this->source, $context["banner"], "image", [], "any", false, false, false, 238);
            echo "\" alt class=\"img-response slider-img\">
            </a>
            ";
        }
      ...
      <div class=\"splide__track\">
         <ul class=\"splide__list\">
            <li class=\"splide__slide\">
               <div class=\"scard\"
                  style=\"background-image: url('image/sl11.png');min-height:400px;background-size: contain;background-repeat: no-repeat;align-items: center;display: flex;\">
                  <div class=\"row\"style=\"    width: 100%;\">
                     <div class=\"col-md-5\"></div>
                     <div class=\"col-md-7 row align-content-center\">
                        <div class=\"tt col-12\" style=\"background-color: #F2F1F0;padding:3%;\">
                           <h2 style=\"font-size: 30px;color:#313131;font-weight:600;\"> Expert Consulting <span
                                 style=\" margin-left:20px;   display: inline-grid;height:8px; width:100px;background:#906CD4;\"></span><br>

                              for Individual Goals
                           </h2>
                           <p style=\"font-size: 18px;color:#656565;\">Our data-driven strategies ensure you make informed
                              decisions that maximise your financial potential. </p>
                        </div>
                        <div class=\"tt1 col-12 row mt-4\">
                           <div class=\"col-md-4\"></div>
                           <div class=\"col-md-8 row \">
                              <div class=\"col-6 mt-3\" style=\"font-size:14px;\">
                                 <img src=\"image/check.png\" alt=\"\"> Wealth Management
                              </div>
                              <div class=\"col-6 mt-3\" style=\"font-size:14px;\">
                                 <img src=\"image/check.png\" alt=\"\"> Retirement Planning
                              </div>
                              <div class=\"col-6 mt-3\" style=\"font-size:14px;\">
                                 <img src=\"image/check.png\" alt=\"\"> Estate Planning
                              </div>
                              <div class=\"col-6 mt-3\" style=\"font-size:14px;\">
                                 <img src=\"image/check.png\" alt=\"\"> Insurance Planning
                              </div>
                              <div class=\"col-8 mt-3\" style=\"font-size:14px;\">
                                 <img src=\"image/check.png\" alt=\"\"> Tax Planning and Preparation
                              </div>
                           </div>
                        </div>
                     </div>
            ...
            <li class=\"splide__slide\">
               <div class=\"scard\"
                  style=\"background-image: url('image/sl12.png');min-height:400px;background-size: contain;background-repeat: no-repeat;align-items: center;display: flex;\">
                  <div class=\"row\"style=\"    width: 100%;\">
                     <div class=\"col-md-5\"></div>
                     <div class=\"col-md-7 row align-content-center\">
                        <div class=\"tt col-12\" style=\"background-color: #F2F1F0;padding:3%;\">
                           <h2 style=\"font-size: 30px;color:#313131;font-weight:600;\"> Wealth Management
                           </h2>
                           <p style=\"font-size: 18px;color:#656565;\">Our data-driven strategies ensure you make informed
                              decisions that maximise your financial potential. </p>
                        </div>
                        <div class=\"tt1 col-12 row mt-4\">
                           ...
                           <div class=\"col-md-8 row \">
                              <div class=\"col-6 mt-3\" style=\"font-size:14px;\">
                                 <img src=\"image/check.png\" alt=\"\"> Investment Management
                              </div>
                              <div class=\"col-6 mt-3\" style=\"font-size:14px;\">
                                 <img src=\"image/check.png\" alt=\"\"> Savings Plans
                              </div>
                              <div class=\"col-6 mt-3\" style=\"font-size:14px;\">
                                 <img src=\"image/check.png\" alt=\"\"> Portfolio Management
                              </div>
            ...
            <li class=\"splide__slide\">
               <div class=\"scard\"
                  ...
                  <div class=\"row\"style=\"    width: 100%;\">
                     ...
                     <div class=\"col-md-7 row align-content-center\">
                        <div class=\"tt col-12\" style=\"background-color: #F2F1F0;padding:3%;\">
                           <h2 style=\"font-size: 30px;color:#313131;font-weight:600;\">  Retirement Planning
                        ...
                        <div class=\"tt1 col-12 row mt-4\">
                           ...
                           <div class=\"col-md-8 row \">
                              <div class=\"col-6 mt-3\" style=\"font-size:14px;\">
                                 <img src=\"image/check.png\" alt=\"\"> Retirement Savings Plans
                              </div>
                              <div class=\"col-6 mt-3\" style=\"font-size:14px;\">
                                 <img src=\"image/check.png\" alt=\"\"> Pension Planning

                              </div>
                              <div class=\"col-6 mt-3\" style=\"font-size:14px;\">
                                 <img src=\"image/check.png\" alt=\"\"> Post-Retirement Income Planning
                              </div>
            ...
            <li class=\"splide__slide\">
               <div class=\"scard\"
                  style=\"background-image: url('image/sl13.png');min-height:400px;background-size: contain;background-repeat: no-repeat;align-items: center;display: flex;\">
                  <div class=\"row\"style=\"    width: 100%;\">
                     <div class=\"col-md-5\"></div>
                     <div class=\"col-md-7 row align-content-center\">
                        <div class=\"tt col-12\" style=\"background-color: #F2F1F0;padding:3%;\">
                           <h2 style=\"font-size: 30px;color:#313131;font-weight:600;\"> Tax Planning and Preparation
                        ...
                        <div class=\"tt1 col-12 row mt-4\">
                           ...
                           <div class=\"col-md-8 row \">
                              <div class=\"col-6 mt-3\" style=\"font-size:14px;\">
                                 <img src=\"image/check.png\" alt=\"\"> Income Tax Planning
                              </div>
                              <div class=\"col-6 mt-3\" style=\"font-size:14px;\">
                                 <img src=\"image/check.png\" alt=\"\"> Tax Filing Assistance

                              </div>
                              <div class=\"col-6 mt-3\" style=\"font-size:14px;\">
                                 <img src=\"image/check.png\" alt=\"\"> Tax Advisory Services
                              </div>
            ...
            <li class=\"splide__slide\">
               <div class=\"scard\"
                  style=\"background-image: url('image/sl15.png');min-height:400px;background-size: contain;background-repeat: no-repeat;align-items: center;display: flex;\">
                  <div class=\"row\"style=\"    width: 100%;\">
                     <div class=\"col-md-5\"></div>
                     <div class=\"col-md-7 row align-content-center\">
                        <div class=\"tt col-12\" style=\"background-color: #F2F1F0;padding:3%;\">
                           <h2 style=\"font-size: 30px;color:#313131;font-weight:600;\"> Estate Planning
                        ...
                        <div class=\"tt1 col-12 row mt-4\">
                           <div class=\"col-md-4\"></div>
                           <div class=\"col-md-8 row \">
                              <div class=\"col-6 mt-3\" style=\"font-size:14px;\">  <img src=\"image/check.png\" alt=\"\"> Wills and Trusts
                              </div>
                              <div class=\"col-6 mt-3\" style=\"font-size:14px;\">
                                 <img src=\"image/check.png\" alt=\"\"> Asset Protection

                              </div>
                              <div class=\"col-6 mt-3\" style=\"font-size:14px;\">
                                 <img src=\"image/check.png\" alt=\"\"> Succession Planning
                              </div>
            ...
            <li class=\"splide__slide\">
               <div class=\"scard\"
                  style=\"background-image: url('image/sl16.png');min-height:400px;background-size: contain;background-repeat: no-repeat;align-items: center;display: flex;\">
                  <div class=\"row\"style=\"    width: 100%;\">
                     <div class=\"col-md-5\"></div>
                     <div class=\"col-md-7 row align-content-center\">
                        <div class=\"tt col-12\" style=\"background-color: #F2F1F0;padding:3%;\">
                           <h2 style=\"font-size: 30px;color:#313131;font-weight:600;\"> Insurance Planning
                        ...
                        <div class=\"tt1 col-12 row mt-4\">
                           <div class=\"col-md-4\"></div>
                           <div class=\"col-md-8 row \">
                              <div class=\"col-6 mt-3\" style=\"font-size:14px;\">  <img src=\"image/check.png\" alt=\"\"> Health Insurance
                              </div>
                              <div class=\"col-6 mt-3\" style=\"font-size:14px;\">
                                 <img src=\"image/check.png\" alt=\"\"> Life Insurance

                              </div>
                              <div class=\"col-6 mt-3\" style=\"font-size:14px;\">
                                 <img src=\"image/check.png\" alt=\"\"> Vehicle Insurance
                              </div>
                              <div class=\"col-6 mt-3\" style=\"font-size:14px;\">
                                 <img src=\"image/check.png\" alt=\"\"> Home Insurance
                              </div>
                              <div class=\"col-6 mt-3\" style=\"font-size:14px;\">
                                 <img src=\"image/check.png\" alt=\"\"> Fire Policy
                              </div>
                              <div class=\"col-6 mt-3\" style=\"font-size:14px;\">
                                 <img src=\"image/check.png\" alt=\"\"> Travel Insurance
                              </div>
                              <div class=\"col-6 mt-3\" style=\"font-size:14px;\">
                                 <img src=\"image/check.png\" alt=\"\"> Disability Insurance
                              </div>
...
<section class=\"container\"
   style=\"background-image: url('image/bg.png');    background-size: cover;background-position: right;\">
   <div class=\"row p-3 \">
...
";
    ...
    {
        return array (  709 => 640,  308 => 241,  299 => 238,  294 => 237,  290 => 236,  283 => 231,  264 => 218,  259 => 217,  255 => 216,  37 => 1,);
    }
