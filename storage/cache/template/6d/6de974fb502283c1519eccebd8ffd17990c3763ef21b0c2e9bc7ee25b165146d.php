...
class __TwigTemplate_264bd4d14b64fb7cc2fa13cc2c515618e9dd5ffc933bc878b599090833d9cb75 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t<a href=\"index.php?route=information/contact\">
\t\t\t\t\t\t\t<button class=\"btn btn-primary \" style=\"padding: 10px 24px;font-size:12px;\">Schedule free consultation</button>
\t\t\t\t\t\t</a>
