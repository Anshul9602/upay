...
class __TwigTemplate_e7419fa05b418a5440ee964fe2290239e8acd3af24eee784e8459dcb1977d41f extends \Twig\Template
{
    private $source;
    private $macros = [];
   ...
   <div class=\"row\">
      ...
      <div class=\"slider_banner col-12 mobile-banner\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["banner"]) {
            // line 224
            echo "            <a href=\"";
            echo twig_get_attribute($this->env, $this->source, $context["banner"], "link", [], "any", false, false, false, 224);
            echo "\">
               <img src=\"";
            // line 225
            echo twig_get_attribute($this->env, $this->source, $context["banner"], "image", [], "any", false, false, false, 225);
            echo "\" alt class=\"img-response slider-img\">
            </a>
            ";
        }
...
<section class=\"container\" style=\"background-image: url('image/bg.png');    background-size: cover;\">
   <div class=\"row p-3 \">
      <div class=\"col-md-6\">
...
";
    ...
    {
        return array (  476 => 407,  295 => 228,  286 => 225,  281 => 224,  277 => 223,  271 => 219,  262 => 216,  257 => 215,  253 => 214,  37 => 1,);
    }
