...
class __TwigTemplate_bb6dcef9a211350745f8eb80ed2543706ada525f790a9f0b71ee37cc0b9f882c extends \Twig\Template
{
    private $source;
    private $macros = [];
   ...
   <div class=\"row\">
      ...
      <div class=\"slider_banner col-12 mobile-banner\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["banner"]) {
            // line 185
            echo "            <a href=\"";
            echo twig_get_attribute($this->env, $this->source, $context["banner"], "link", [], "any", false, false, false, 185);
            echo "\">
               <img src=\"";
            // line 186
            echo twig_get_attribute($this->env, $this->source, $context["banner"], "image", [], "any", false, false, false, 186);
            echo "\" alt
                  class=\"img-response slider-img\">
            </a>
            ";
...
";
    ...
    {
        return array (  448 => 379,  257 => 190,  247 => 186,  242 => 185,  238 => 184,  231 => 179,  221 => 175,  216 => 174,  212 => 173,  37 => 1,);
    }
