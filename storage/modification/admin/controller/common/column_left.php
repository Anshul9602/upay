...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		...
		if ($this->user->hasPermission('access', 'extension/module/discounts_pack/discount_category')) {
			$discounts[] = array(
				'name'     => $this->language->get('text_category'),
				'href'     => $this->url->link('extension/module/discounts_pack/discount_category', 'user_token=' . $this->session->data['user_token'], true),
				'children' => array()	
			);
		}
