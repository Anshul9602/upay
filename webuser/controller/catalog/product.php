...
class ControllerCatalogProduct extends Controller {
	...
	protected function getList() {
		...
		$data['download_inventory'] = $this->url->link('extension/export_import/download_inventory', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['upload_inventory'] = $this->url->link('extension/export_import/upload_inventory', 'user_token=' . $this->session->data['user_token'] . $url, true);
