    			...
    			image: function() {
					...
					var button = ui.button({
						...
						click: function () {
							...
							$.ajax({
								url: 'index.php?route=extension/module/elfinder/ui&user_token=' + getURLVar('user_token') + '&from=texteditor',
								dataType: 'html',
								beforeSend: function() {
								...
								success: function(html) {
									...
									$('#modal-image').delegate('.insert_image', 'click', function(e) {
										e.preventDefault();
										
										var img_url = $('.insert_image_span').text();
										
										$(element).summernote('insertImage', img_url);
